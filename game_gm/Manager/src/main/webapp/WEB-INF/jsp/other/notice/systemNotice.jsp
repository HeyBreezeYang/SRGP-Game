		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				<form action="notice/saveOrUpdateNotice" role="form" class="form-horizontal" method="post" id="noticeLoginForm">
					...
					<input type="hidden" id="noticeType" name="noticeType" value="系统公告">
					...
					<input type="text" name="highlightTitle" class="form-control" id="highlightTitle" value="系统公告" />
