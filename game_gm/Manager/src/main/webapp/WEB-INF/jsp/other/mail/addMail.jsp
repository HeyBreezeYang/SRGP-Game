		...
		<div class="panel panel-default">
				<div class="panel-heading">
					...
					<form action="mail/saveOrUpdateMail" role="form" class="form-horizontal" method="post" id="mailLoginForm">
						...
						<input type="hidden" id="createBy" name="createBy" value="">
    ...
    --%>						<div class="form-group" id="make">
						...
						<div class="form-group">
							...
							<div class="col-sm-11" id="testPamras">
								<input type="text" name="mailTitle" class="form-control" id="mailTitle" value="" />
							</div>
						</div>
						...
						<div class="form-group">	
							...
							<div class="col-sm-11">
								<textarea class="form-control" rows="13" name="mailContext" id="mailContext" style="resize: none;" ></textarea>
							</div>

						</div>
						<div>
							需要发送的玩家：<input type="text" name="username" value="">
						...
						<div class="form-group">
							...
							<div class="col-sm-11">
								<textarea class="form-control" rows="13" name="enclosure" id="enclosure" style="resize: none;" ></textarea>
							</div>
						</div>
