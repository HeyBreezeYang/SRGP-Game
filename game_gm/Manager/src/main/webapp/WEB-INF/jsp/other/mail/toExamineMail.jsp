	...
	<div class="panel panel-default">
		...
		<div class="panel-body">
			<form action="mail/saveOrUpdateMail" role="form" class="form-horizontal" method="post" id="mailLoginForm">
				...
				<input type="hidden" id="operation" name="operation" value="toExamine">
				<div>
...
--%>						<div class="form-group" id="make">
				...
				<div class="form-group">
					...
					<div class="col-sm-4">
						<button class="btn btn-purple btn-block" onclick="toExamine(${mail["id"]},2);" type="button">通过</button>
					</div>
					<div class="col-sm-4">
						<button class="btn btn-purple btn-block" onclick="toExamine(${mail["id"]},3);" type="button">驳回</button>
					</div>
					<div class="col-sm-4">
						<button class="btn btn-purple btn-block" onclick="editTESuccess();" type="button">编辑并通过</button>
					</div>
				</div>
			</form>
		</div>
...
<script type="text/javascript">
    ...
    function editTESuccess(){
        $("#setMarkDiv").html("确定修改并通过当前邮件吗？");
    ...
    function toExamine(id,type){

        jQuery.ajax({
            url: "mail/toExamineMailStatus",
            type:"POST",
            async: false,
