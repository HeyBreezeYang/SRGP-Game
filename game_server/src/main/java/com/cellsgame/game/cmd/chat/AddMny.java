 ...
 */
public class AddMny extends AChatCMD {
    @Override
    ...
    public Map execute(PlayerVO src, CMD cmd, String command, String[] parm) throws Exception {
        ...
        SyncFuncType.ChangeCur.getFunc().checkAndExec(info, cmd, src, new FuncParam(CurrencyType.MONEY.getType(), Integer.parseInt(parm[1])));
        return info;
    }
}
