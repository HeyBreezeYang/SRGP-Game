...
public class CurrencyLogPro extends LogProcess {

	private static String CURRENCY_TYPE = "type";
	...
	public Map<String, Object> builderInfo(EvtHolder holder, GameEvent e) {
		...
		result.put(CURRENCY_TYPE, e.getParam(EvtParamType.CURRENCY_TYPE, 0));
